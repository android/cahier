...
private fun TextureLayerEditor(
    ...
    if (layer.mapping == ProtoBrushPaint.TextureLayer.Mapping.MAPPING_TILING) {
        ...
        NumericField(
            ...
            limits = NumericLimits.standard(0.1f, 10f, 0.1f),
    ...
    NumericField(
        ...
        limits = NumericLimits.standard(-5f, 5f, 0.1f),
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(12.dp)) {
                NumericField(
                    ...
                    limits = NumericLimits.standard(1f, 10f, 1f),
                    onValueChanged = {
                        onLayerChanged(
                ...
                NumericField(
                    ...
                    limits = NumericLimits.standard(1f, 64f, 1f),
                    onValueChanged = {
                        onLayerChanged(
                ...
                NumericField(
                    ...
                    limits = NumericLimits.standard(0f, 5f, 0.1f),
                    onValueChanged = {
                        onLayerChanged(
    ...
    when (colorFunction.functionCase) {
        ProtoColorFunction.FunctionCase.OPACITY_MULTIPLIER -> {
            NumericField(
                ...
                limits = NumericLimits.standard(0f, 2f, 0.05f),
                onValueChanged = {
                    onFunctionChanged(
